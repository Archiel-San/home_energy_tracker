package com.archiecode.insight_service.service;

import com.archiecode.insight_service.client.UsageClient;
import com.archiecode.insight_service.dto.DeviceDto;
import com.archiecode.insight_service.dto.InsightDto;
import com.archiecode.insight_service.dto.UsageDto;
...
public class InsightService {
    ...
    public InsightDto getOverview(Long userId){
        //fetch the data from the usage service
        ...
        return InsightDto.builder().userId(userId).tips(response.getResult().getOutput().getText())
